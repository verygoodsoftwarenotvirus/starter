...
func TestBuilder_BuildSwitchActiveAccountRequest(T *testing.T) {
	...
	const expectedPathFormat = "/api/v1/users/account/select"
...
func TestBuilder_BuildGetCurrentAccountRequest(T *testing.T) {
	T.Parallel()
	...
	T.Run("standard", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildGetCurrentAccountRequest(helper.ctx)
		assert.NoError(t, err)
...
func TestBuilder_BuildCreateAccountRequest(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		exampleInput := converters.ConvertAccountToAccountCreationRequestInput(exampleAccount)
	...
	T.Run("with invalid input", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildCreateAccountRequest(helper.ctx, &types.AccountCreationRequestInput{})
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
...
func TestBuilder_BuildAddUserRequest(T *testing.T) {
	...
	T.Run("standard", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildInviteUserToAccountRequest(helper.ctx, exampleAccountID, exampleInput)
		assert.NoError(t, err)
	...
	T.Run("with nil input", func(t *testing.T) {
		...
		actual, err := helper.builder.BuildInviteUserToAccountRequest(helper.ctx, exampleAccountID, nil)
		assert.Nil(t, actual)
		assert.Error(t, err)
	})
