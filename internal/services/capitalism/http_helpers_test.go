...
type capitalismServiceHTTPRoutesTestHelper struct {
	ctx            context.Context
	req            *http.Request
...
func buildTestHelper(t *testing.T) *capitalismServiceHTTPRoutesTestHelper {
	t.Helper()

	helper := &capitalismServiceHTTPRoutesTestHelper{}
