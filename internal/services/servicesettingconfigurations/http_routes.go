...
// ForAccountHandler returns a GET handler that returns a service setting configuration.
func (s *service) ForAccountHandler(res http.ResponseWriter, req *http.Request) {
	ctx, span := s.tracer.StartSpan(req.Context())
	defer span.End()
